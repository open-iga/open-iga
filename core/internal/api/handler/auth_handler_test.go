...
func setupRouterWithMockAuthService(t *testing.T) (*chi.Mux, *testutil.MockAuthService) {
	t.Helper()
...
func TestHandler_AuthDetails(t *testing.T) {
	...
	t.Run("returns 500 when the consent details failed to generate", func(t *testing.T) {
		router, authServiceMock := setupRouterWithMockAuthService(t)
		authServiceMock.EXPECT().GetConsentPageDetails(gomock.Any(), "google").Return(nil, errors.New("unsupported provider"))
	...
	t.Run("returns 200 with valid auth code URL and sets the state cookie", func(t *testing.T) {
		router, authServiceMock := setupRouterWithMockAuthService(t)
		authServiceMock.EXPECT().GetConsentPageDetails(gomock.Any(), "google").Return(
...
func TestHandler_AuthCallback(t *testing.T) {
	...
	t.Run("returns 500 when generating session fails", func(t *testing.T) {
		router, authServiceMock := setupRouterWithMockAuthService(t)
		authServiceMock.EXPECT().GenerateSession(gomock.Any(), "google", "code").Return(nil, errors.New("failed to generate session"))
	...
	t.Run("returns 201 with redirect details and sets session id cookie", func(t *testing.T) {
		router, authServiceMock := setupRouterWithMockAuthService(t)
		authServiceMock.EXPECT().GenerateSession(gomock.Any(), "google", "code").Return(&domain.Session{
